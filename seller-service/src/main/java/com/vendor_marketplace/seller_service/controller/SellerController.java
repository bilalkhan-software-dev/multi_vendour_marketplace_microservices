...
public class SellerController {
    ...
    ResponseEntity<Boolean> validateSeller(@PathVariable Long id) {
        return ResponseEntity.ok(sellerService.isSellerExist(id));
    }

    @GetMapping("/validate/{id}")
    ResponseEntity<Boolean> validateAuthUserSeller(@PathVariable String id) {
        return ResponseEntity.ok(sellerService.isSellerExist(id));
    }
