package com.vendor_marketplace.transaction_report_service.aop;
...
public class AspectForLogging {
    ...
    @Around("execution(* com.vendor_marketplace.transaction_report_service.controller..*(..))")
    public Object loggerForController(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint);
    }

    @Around("execution(* com.vendor_marketplace.transaction_report_service.services..*(..))")
    public Object loggerForService(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint);
    }

    @Around("execution(* com.vendor_marketplace.transaction_report_service.dao..*(..))")
