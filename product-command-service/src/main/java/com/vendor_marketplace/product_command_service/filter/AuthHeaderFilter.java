package com.vendor_marketplace.product_command_service.filter;

import com.vendor_marketplace.common.dto.enums.USER_ROLE;
import com.vendor_marketplace.product_command_service.handler.GenericResponse;
...
public class AuthHeaderFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // Validate role - only SELLER and ADMIN are allowed
        try {
