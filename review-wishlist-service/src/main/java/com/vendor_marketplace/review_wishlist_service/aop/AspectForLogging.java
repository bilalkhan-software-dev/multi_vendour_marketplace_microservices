package com.vendor_marketplace.review_wishlist_service.aop;
...
public class AspectForLogging {
    ...
    @Around("execution(* com.vendor_marketplace.review_wishlist_service.controller..*(..))")
    public Object loggerForController(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint);
    }

    @Around("execution(* com.vendor_marketplace.review_wishlist_service.services..*(..))")
    public Object loggerForService(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint);
    }

    @Around("execution(* com.vendor_marketplace.review_wishlist_service.dao..*(..))")
