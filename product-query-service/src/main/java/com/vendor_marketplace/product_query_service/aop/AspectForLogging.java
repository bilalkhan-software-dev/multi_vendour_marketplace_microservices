package com.vendor_marketplace.product_query_service.aop;
...
public class AspectForLogging {
    ...
    @Around("execution(* com.vendor_marketplace.product_query_service.controller..*(..))")
    public Object loggerForController(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint);
    }

    @Around("execution(* com.vendor_marketplace.product_query_service.services..*(..))")
    public Object loggerForService(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint);
    }

    @Around("execution(* com.vendor_marketplace.product_query_service.dao..*(..))")
